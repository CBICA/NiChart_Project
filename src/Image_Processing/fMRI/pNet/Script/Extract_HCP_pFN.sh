...
####################################################################################
# Yuncong Ma, 3/10/2023
# Use it as a script or a function to perform the personalized FN computation for HCP
# Surface data format, using precomputed gFN
# bash /cbica/home/mayun/Projects/NMF/IPP/Script/Extract_HCP_pFN.sh
####################################################################################
...
parse()
{
    # Default setting
    K=17
    dir_gFN=/cbica/home/mayun/Projects/NMF/Group_FN/HCP_Surface
    exp_name=Test
...
# Brain_Template
file_template=$dir_main/Brain_Template/HCP_Surface/Brain_Surface.mat
file_gNb=$dir_main/Brain_Template/HCP_Surface/gNb.mat

# Group FN
file_gFN=$dir_main/Group_FN/HCP_Surface/gFN_$K.mat

# Data Folder and file list file
dir_data=$dir_main/Data/$exp_name
mkdir -p $dir_data
file_scan=$dir_main/Data/Test/rfMRI_REST1_LR_Atlas_MSMAll_hp2000_clean.dtseries.nii
file_list=$dir_main/Data/Test/file_list.txt
if test -f "$file_list"
then
    rm ${file_list}
fi
...
file_log=$dir_log/Extract_HCP_pFN.log
if test -f "$file_log"
then
    rm ${file_log}
fi
