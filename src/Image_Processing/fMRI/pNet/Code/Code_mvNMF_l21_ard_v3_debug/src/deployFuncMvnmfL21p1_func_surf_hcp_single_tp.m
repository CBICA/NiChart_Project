function deployFuncMvnmfL21p1_func_surf_hcp_single_tp(sbjListFile,sbjTCFolder,wbPath,prepDataFile,outDir,resId,initName,K,alphaS21,alphaL,vxI,spaR,ard,eta,iterNum,calcGrp,parforOn,timepointFile)
...
Debug=1;
if Debug==1
    fprintf('\n--deployFuncMvnmfL21p1_func_surf_hcp_single_tp--\n');
    display(sbjListFile);
    display(sbjTCFolder);
    display(wbPath);
