...
f_img=os.path.join(st.session_state.paths['root'], 'resources', 'images', 'dlicv+dlmuse_segmask.png')
...
f_img=os.path.join(st.session_state.paths['root'], 'resources', 'images', 'combat_agetrend.png')
