...
def panel_upload_multi_subject():
    ...
    with st.popover("Participants CSV"):
        ...
        st.info("Most pipelines require some clinical or demographic information about participants. Below you can download a template CSV file to fill in. If you don't have information for a certain column, feel free to delete it. When ready, drag-and-drop to the file uploader.")
